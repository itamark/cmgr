  ...
  <div class="large-12 columns">
    ...
    <!--  <div class="row">
      <div class="large-12 columns">
        ...
        <?php echo $this->Paginator->sort('Item.upvotes', 'Top', array('class' => 'button small')); ?>
        <?php echo $this->Paginator->sort('Item.score', 'Hot', array('class' => 'button small')); ?>
        <?php echo $this->Paginator->sort('Item.created', 'Recent', array('class' => 'button small')); ?>
      </div>
    </div> -->
