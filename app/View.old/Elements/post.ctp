...
<div class="upvote pull-left">
          ...
          <div class="large-1 columns">
<a data-dropdown="drop<?php echo h($item['Item']['id']); ?>"  data-options="align:left" aria-controls="drop1" aria-expanded="false">...</a>
<ul id="drop<?php echo h($item['Item']['id']); ?>" class="f-dropdown" data-dropdown-content aria-hidden="true" tabindex="-1">
